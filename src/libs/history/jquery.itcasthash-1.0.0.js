...
(function ($) {
    ...
    //$.fn.browser.msie = /msie/.test(navigator.userAgent.toLowerCase());
    //$.fn.browser = function () {
    ...
    //var aa = /msie/.test(navigator.userAgent.toLowerCase());
    if (/msie/.test(navigator.userAgent.toLowerCase()) && document.documentMode && document.documentMode >= 8) {
        $.extend({
    ...
    $.extend({
        locationHash: function(hash) {
            ...
            if (/msie/.test(navigator.userAgent.toLowerCase())) updateIEFrame(hash)

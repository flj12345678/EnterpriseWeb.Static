...
; !function (window, undefined) {
    ...
    Class.pt.set = function (times) {
        ...
        switch (config.type) {
            ...
            case 4:
                ...
                //修改tip位置,左偏移15px; edit by null
                fowo.tipLeft=fowo.tipLeft-15;
    ...
    Class.pt.autoArea = function (times) {
        ...
        switch (config.type) {
            ...
            case 1:
                ...
                if (aBtn.length === 0) {
                    layerE.find('.xubox_botton').remove();
                }
                break;
            case 2:
    ...
    ready.run = function () {
        ...
        win = $(window);
        doms.html = $('html');
        layer.use('../../global/plugins/layer/skin/layer.css');

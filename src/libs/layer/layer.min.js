...
; !function (window, undefined) {
    ...
    var Class = function (setings) {
        ...
        //edit by null 2015.06.03
        //that.index = setings.index || layer.index++;
        var layerIndex = $(window).data('layerIndex') || 0;
        layerIndex = layerIndex + 1;
        $(window).data('layerIndex', layerIndex);
        that.index = layerIndex;
    ...
    Class.pt.space = function (html) {
        ...
        config.closeBtn[1] && (closebtn += '<a class="xubox_close xulayer_png32 xubox_close' + config.closeBtn[0] + '" style="' + (config.type === 4 ? 'position:absolute; right:-3px; _right:7px; top:-4px;' : '') + '"></a>');
        ...
        if (config.title && (config.type !== 3 || config.type !== 4)) {
            ...
            switch (confbtn.btns) {
                case 0:
                    ...
                    break;
                case 1:
                    layerBtn.html('<a class="xubox_yes xubox_botton1">' + confbtn.btn[0] + '</a>');
                    break;
                case 2:
                    layerBtn.html('<a class="xubox_yes xubox_botton2">' + confbtn.btn[0] + '</a>' + '<a class="xubox_no xubox_botton3">' + confbtn.btn[1] + '</a>');

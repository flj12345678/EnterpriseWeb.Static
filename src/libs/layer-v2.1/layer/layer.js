...
var layer = {
    ...
    config: function(options, fn){
        ...
        layer.use('skin/layer_cepin_pc.css', (options.extend && options.extend.length > 0) ? (function loop(){
    ...
    msg: function(content, options, theme){ //最常用提示层
        var type = typeof options === 'function', rskin = ready.config.skin;
        var skin = (rskin ? rskin + ' ' + rskin + '-msg '+theme : '')||'layui-layer-msg '+theme;
        ...
        return layer.open($.extend({
            ...
            skin: skin + ' layui-layer-msg',
            shift: shift
        } : function(){
           options = options || {};
           if(options.icon === -1 || options.icon === undefined && !ready.config.skin){
               options.skin = skin + ' ' + (options.skin||'layui-layer-msg');
           }
           return options;
        }()));  
    },
...
'function' === typeof define ? define(function(){
   ...
   ready.run();
   layer.use('skin/layer_cepin_pc.css');
}();
